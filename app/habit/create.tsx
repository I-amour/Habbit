...
import { scheduleHabitReminder, scheduleIntervalReminders, formatTime } from '../../src/utils/notifications';
...
export default function CreateHabitScreen() {
  ...
  const checkBadges = useGamificationStore(s => s.checkAndUnlockBadges);
  ...
  const handleSave = async () => {
    ...
    if (isInterval) {
      await scheduleIntervalReminders(habit);
